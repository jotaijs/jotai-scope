...
import { assertIsDevStore, PrdStore, WithJestMock } from '../../ScopeProvider2/utils'
...
const deriveCallback: DeriveCallack = jest.fn((baseGetAtomState) => {
  getAtomState = jest.fn((atom, originAtom) => {
...
const atomC = atom(null, (get, set, value: SetStateAction<number>) => {
  set(atomA, value)
})
