...
export function createScope(
   ...
   */
  function proxyAtomState<Value>(anAtom: Atom<Value>, atomState: AtomState<Value>) {
    ...
    if (!(atomState.d instanceof MapProxy)) {
      atomState.d = new MapProxy(atomState.d.entries(), function notifyListeners(action) {
 ...
 */
function createAtomState<Value>(atomState?: AtomState<Value>): AtomState<Value> {
